...
use App\Http\Livewire\CrudCash;
use App\Http\Livewire\CrudPurchase;
...
Route::get('cash', CrudCash::class);
Route::get('purchase', CrudPurchase::class);
Route::get('salesHistory', SaleComponent::class);
Route::get('purchaseHistory', PurchaseComponent::class);
